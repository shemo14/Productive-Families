...
class OrderDetails extends Component {
    ...
    componentWillMount(){
        this.props.getOrderDetails(this.props.lang, this.props.navigation.state.params.order_id)
    }
            ...
            <Container>
                ...
                <Content contentContainerStyle={styles.bgFullWidth} style={styles.contentView}>
                    <ImageBackground source={require('../../assets/images/bg_img.png')} style={[styles.bgFullWidth]}>
                                                        ...
                                                        <View style={[styles.overHidden]}>
                                                            <View style={[styles.rowGroup]}>
                                                                <Text
                                                                    ...
                                                                    numberOfLines={1} prop with ellipsizeMode="head">{product.product_info.product_name}</Text>
                                                            ...
                                                            <Text
                                                                ...
                                                                numberOfLines={1} prop with ellipsizeMode="head">{product.product_info.product_category} - {product.product_info.product_sub_category}</Text>
                                                            <Text
                                                                style={[styles.textRegular, styles.text_bold_gray, styles.Width_100, styles.textSize_12, styles.textLeft]}
                        ...
                        <View
                            style={[styles.Width_95, {marginTop:5 , marginBottom:15}, styles.marginHorizontal_10, styles.SelfCenter]}>
                            <View style={[styles.lightOverlay, styles.Border]}></View>
                            <View
                                style={[styles.Width_100, styles.overHidden, styles.bg_White, styles.Border, styles.bgFullWidth, styles.paddingHorizontal_7, styles.paddingVertical_7]}>
                                <View
                                ...
                                <View
                                    ...
                                    <View
                                        ...
                                        <View style={[styles.notiBlock, {borderBottomWidth: 0, marginBottom: 0}]}>
                                            <Image source={{uri: this.props.orderDetails.provider.avatar}} resizeMode={'cover'}
